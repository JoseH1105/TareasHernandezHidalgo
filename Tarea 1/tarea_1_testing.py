...
def test_casos_error_multiplo_2():
    estado, result = tarea_1_solution.multiplo_2(base="c", multiplo=2)
    assert estado == -400
    assert result is None

    estado, result = tarea_1_solution.multiplo_2(base=2, multiplo="c")
    assert estado == -400
    assert result is None

    estado, result = tarea_1_solution.multiplo_2(base="", multiplo="c")
    assert estado == -400
    assert result is None

    estado, result = tarea_1_solution.multiplo_2(base=900, multiplo=7)
    assert estado == -500
    assert result is None
...
def test_casos_exito_multiplo_2():
    ...
    print(param1, "---", param2)
    estado, result = tarea_1_solution.multiplo_2(
